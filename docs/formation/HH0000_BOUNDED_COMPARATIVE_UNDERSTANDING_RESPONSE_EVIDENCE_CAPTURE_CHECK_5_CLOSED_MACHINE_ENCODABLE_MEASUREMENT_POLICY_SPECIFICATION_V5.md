# HH-0000 Check 5 Corrected Canonical Measurement Policy Candidate V5

**Status:** CANDIDATE
**Specification date:** 2026-08-15
**Schema:** `HH-CHECK-5-CLOSED-MEASUREMENT-POLICY-5`
**Canonical payload byte length:** `423284`
**Canonical payload SHA-256:** `78a8ece526551eaf4a00c5addbf72d71b7a17a8cfc4bb809bfc687c76a3f03cf`
**Historical closed POLICY-4:** `422479` bytes / `e39d39e1e510d5ffa79abcdc81dfef865fbe4d02bdacfd7e99e434c254295f7d` / unchanged historical governed Evidence
**Governed implementation-source access:** None
**Check 5:** `UNMEASURED`
**Check 6:** `NOT RUN`
**Implementation:** `UNACCEPTED`
**Authority result:** The one POLICY-5 candidate-construction-and-immediate-validation Authority is consumed by this candidate and exhausted.

# Repository Traceability

**Principle:** Truth before certainty; evidence before claims; human Authority; smallest justified change.
**Theory:** A corrected candidate serializes only the settled imported-identity distinction, preserves historical closed bytes, and carries no closure or execution consequence.
**Architecture:** One complete POLICY-5 payload copied from closed POLICY-4 with one successor schema identity, one closed ImportedIdentity definition, one IMPORTED_BINDING field replacement, and only directly dependent compatibility representations.
**Engineering:** Pre-write identity verification, closed three-class structural comparison, seven invalid-combination falsifiers, deterministic canonicalization, one exclusive write, one immediate reread, and mandatory stop.
**Milestone:** Not Applicable.
**Evidence:** Candidate construction and candidate-local identity only. No closure, namespace binding derivation, implementation, instrument, Check 5, Check 6, freeze, or acceptance Evidence.
...
```json
{
  ...
  "normalizationSchemas": {
    ...
    "ImportedIdentity": {
      ...
      "variantCardinality": "EXACTLY_ONE",
      "objectsClosed": true,
      "unknownKindAllowed": false
    }
  },
  "nodeRecordCompleteness": {
    ...
    "recordSchemas": {
      ...
      "IMPORTED_BINDING": "{module:string,importedIdentity:ImportedIdentity,localName:string,typeOnly:boolean}",
    ...
    "rules": {
      ...
      "defaultImportIdentity": "ImportDeclaration with importKind=DEFAULT_VALUE requires each linked IMPORTED_BINDING importedIdentity={kind:IMPORTED_OR_EXPORTED_NAME,name:default}",
      "namedImportIdentity": "ImportDeclaration with importKind=NAMED_VALUE|NAMED_TYPE|NAMED_MIXED requires each linked IMPORTED_BINDING importedIdentity={kind:IMPORTED_OR_EXPORTED_NAME,name:SOURCE_IMPORTED_OR_EXPORTED_IDENTITY} and preserves localName independently",
      "namespaceImportIdentity": "ImportDeclaration with importKind=NAMESPACE requires each linked IMPORTED_BINDING importedIdentity={kind:MODULE_NAMESPACE_OBJECT}"
    }
  },
  "captureSchemas": {
    "EnumerationCapture": {
...
POLICY-5 mechanically preserves the complete POLICY-4 payload except for the new schema identifier, the exact ImportedIdentity definition and IMPORTED_BINDING field replacement, and the three directly dependent default, named, and namespace compatibility rules. POLICY-4 remains byte-for-byte unchanged historical governed Evidence.

This candidate remains `CANDIDATE`. Its identity does not establish corrected canonical-policy closure, namespace binding derivation, instrument Authority, Check 5 Authority, Check 6 Authority, freeze, or acceptance.

## 5. Authority Stop

Candidate construction and immediate validation stop here. No closure review or downstream derivation is begun or authorised by this action.
